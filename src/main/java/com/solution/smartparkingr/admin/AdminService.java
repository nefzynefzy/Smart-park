...
public class AdminService {
    ...
    public AnalyticsDataDTO getAnalyticsData() {
        ...
        List<Long> activeUserIds = reservationRepository.findByStatusNotIn(
                        List.of(Reservation.ReservationStatus.CANCELLED, Reservation.ReservationStatus.EXPIRED)
                ).stream()
    ...
    public Map<String, Object> getChartData(String period) {
        ...
        if (period.equals("day")) {
            ...
            for (int i = 0; i < 24; i++) {
                ...
                long occupiedSpots = reservationRepository.findByStartTimeBetween(hourStart, hourStart.plusHours(1)).stream()
